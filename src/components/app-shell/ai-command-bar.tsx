...
const suggestions = [ "What needs my attention today?", "Show members likely to churn", "Why did revenue change this month?", "Which leads should I follow up with?",
];
...
export function AICommandBar() {
 ...
 className="w-full max-w-2xl overflow-hidden rounded-xl border bg-card shadow-sm"
