...
export function DataTable<T>({
 ...
 className={cn( "rounded-xl border bg-card p-4 shadow-sm transition-colors focus-visible:outline-2 focus-visible:outline-ring",
 ...
 className={cn( "transition-colors focus-visible:outline-2 focus-visible:outline-ring focus-visible:outline-offset-[-2px]",
