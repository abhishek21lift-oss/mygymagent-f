       ...
       <CardHeader className="border-b border-stone-100/80 bg-gradient-to-r from-emerald-50/80 via-white to-teal-50/60 dark:border-white/10 dark:from-emerald-500/10 dark:via-transparent dark:to-teal-500/10">
        <div className="flex items-start justify-between gap-4">
         <div className="flex items-start gap-3">
          <span className="flex size-12 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-emerald-500 to-teal-600 text-white shadow-lg"><MessageCircle className="size-6" aria-hidden="true" /></span>
...
function TestSendCard({ canManage, orgCountry }: { canManage: boolean; orgCountry: string | null }) {
 ...
 return (
  <Card className="overflow-hidden border-white/90 bg-white/88 shadow-xl shadow-violet-900/5 backdrop-blur-xl dark:border-white/10 dark:bg-stone-950/80">
   <CardHeader className="border-b border-stone-100/80 bg-gradient-to-r from-emerald-50/80 via-white to-teal-50/60 dark:border-white/10 dark:from-emerald-500/10 dark:via-transparent dark:to-teal-500/10">
    <div className="flex items-start gap-3">
     <span className="flex size-11 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-emerald-500 to-teal-600 text-white shadow-lg"><Send className="size-5" aria-hidden="true" /></span>
     <div>
...
function TemplatesCard() {
 ...
 return (
  <Card className="overflow-hidden border-white/90 bg-white/88 shadow-xl shadow-violet-900/5 backdrop-blur-xl dark:border-white/10 dark:bg-stone-950/80">
   <CardHeader className="border-b border-stone-100/80 bg-gradient-to-r from-emerald-50/80 via-white to-teal-50/60 dark:border-white/10 dark:from-emerald-500/10 dark:via-transparent dark:to-teal-500/10">
    <div className="flex items-start gap-3">
     <span className="flex size-11 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-emerald-500 to-teal-600 text-white shadow-lg"><FileText className="size-5" aria-hidden="true" /></span>
     <div>
    ...
    {templatesQuery.isLoading ? (
     ...
     <ul className="flex flex-col gap-3">
      {templatesQuery.data.map((template) => (
       <li key={template.key} className="rounded-xl border border-stone-200/70 bg-white/70 p-4 dark:border-white/10 dark:bg-white/5">
...
function DeliveryLogCard() {
 ...
 return (
  <Card className="overflow-hidden border-white/90 bg-white/88 shadow-xl shadow-violet-900/5 backdrop-blur-xl dark:border-white/10 dark:bg-stone-950/80">
   <CardHeader className="border-b border-stone-100/80 bg-gradient-to-r from-emerald-50/80 via-white to-teal-50/60 dark:border-white/10 dark:from-emerald-500/10 dark:via-transparent dark:to-teal-500/10">
    <div className="flex items-start gap-3">
     <span className="flex size-11 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-emerald-500 to-teal-600 text-white shadow-lg"><History className="size-5" aria-hidden="true" /></span>
     <div>
 ...
 return (
  <Card className="overflow-hidden border-rose-200 bg-rose-50/40 shadow-xl shadow-rose-900/5 backdrop-blur-xl dark:border-rose-400/20 dark:bg-rose-500/5">
   <CardHeader className="border-b border-rose-100 bg-gradient-to-r from-rose-50/80 via-white to-orange-50/60 dark:border-rose-400/10 dark:from-rose-500/10 dark:via-transparent dark:to-orange-500/10">
    <div className="flex items-start gap-3">
     <span className="flex size-11 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-rose-500 to-orange-500 text-white shadow-lg"><TriangleAlert className="size-5" aria-hidden="true" /></span>
     <div>
...
function Info({ label, value, mono }: { label: string; value: string; mono?: boolean }) {
 return <div className="rounded-xl border border-stone-200/70 bg-white/70 p-4 dark:border-white/10 dark:bg-white/5"><div className="text-xs font-black uppercase tracking-[.16em] text-stone-500 dark:text-stone-400">{label}</div><div className={`mt-1 break-all text-sm font-bold text-stone-900 dark:text-stone-100 ${mono ? "font-mono" : ""}`}>{value}</div></div>
}
