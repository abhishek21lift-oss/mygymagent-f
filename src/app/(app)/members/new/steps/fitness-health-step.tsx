...
export function FitnessHealthStep({ data, onUpdate, onContinue, onBack }: FitnessHealthStepProps) {
 ...
 {/* Basic Measurements */}
 <section aria-labelledby="fitness-measure-heading" className="rounded-xl border border-cyan-100/70 bg-card p-5">
 <h3 id="fitness-measure-heading" className="flex items-center gap-2.5 font-semibold text-lg font-semibold tracking-tight text-stone-950">
 ...
 {/* Health Info */}
 <section aria-labelledby="fitness-health-heading" className="rounded-xl border border-violet-100/70 bg-card p-5">
 <h3 id="fitness-health-heading" className="flex items-center gap-2.5 font-semibold text-lg font-semibold tracking-tight text-stone-950">
 ...
 {/* PAR-Q Section */}
 <section aria-labelledby="fitness-parq-heading" className="rounded-xl border border-amber-100/70 bg-card p-5">
 <div className="flex items-center gap-2.5">
 <span className="flex size-10 items-center justify-center rounded-xl bg-amber-500 text-white shadow-md shadow-amber-500/25">
 <ShieldCheck className="size-4" aria-hidden="true" />
 </span>
 <div>
 <h3 id="fitness-parq-heading" className="font-semibold text-lg font-semibold tracking-tight text-stone-950">PAR-Q Health Questionnaire</h3>
 ...
 {anyParqYes && (
 <Alert variant="warning" className="mt-4 rounded-lg border-amber-200 bg-muted/40">
 ...
 {/* Waiver Consent */}
 <div className="flex items-start gap-3 rounded-xl border border-emerald-200/70 bg-muted/40 p-5">
 <Checkbox
 id="waiverConsent"
