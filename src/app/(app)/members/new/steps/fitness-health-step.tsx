...
export function FitnessHealthStep({ data, onUpdate, onContinue, onBack }: FitnessHealthStepProps) {
 ...
 return (
  <div className="flex flex-col gap-5">
   {/* Basic Measurements */}
   <section aria-labelledby="fitness-measure-heading" className="rounded-xl border border-cyan-100/70 bg-white/60 p-5">
   ...
   {/* Health Info */}
   <section aria-labelledby="fitness-health-heading" className="rounded-xl border border-violet-100/70 bg-white/60 p-5">
   ...
   {/* PAR-Q Section */}
   <section aria-labelledby="fitness-parq-heading" className="rounded-xl border border-amber-100/70 bg-white/60 p-5">
   ...
   {/* Waiver Consent */}
   <div className="flex items-start gap-3 rounded-xl border border-emerald-200/70 bg-gradient-to-br from-emerald-50/70 via-white to-teal-50/50 p-5">
    <Checkbox
     id="waiverConsent"
