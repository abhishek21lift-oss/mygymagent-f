...
export function LeadSelectionStep({ onSelectLead, onSkip }: LeadSelectionStepProps) {
 ...
 return (
  <div className="flex flex-col gap-5">
   <div className="rounded-xl border border-violet-100/70 bg-gradient-to-br from-violet-50/70 via-white to-cyan-50/60 p-4">
   ...
   {leadsQuery.isLoading ? (
    <div className="space-y-2" aria-label="Loading leads">
     {[1, 2, 3].map((i) => (
      <div key={i} className="h-16 animate-pulse rounded-xl bg-gradient-to-r from-violet-50 to-cyan-50" />
     ))}
    </div>
       ...
       <CardContent className="p-3.5">
        <div className="flex items-center justify-between gap-3">
         <div className="flex min-w-0 items-center gap-3">
          <span className={`flex size-10 shrink-0 items-center justify-center rounded-lg font-black text-white shadow-md ${selectedLeadId === lead.id ? "bg-gradient-to-br from-violet-600 to-cyan-500" : "bg-gradient-to-br from-stone-400 to-stone-500"}`} aria-hidden="true">
