...
export function ReviewStep({ data, onEdit, onSubmit, isSubmitting }: ReviewStepProps) {
 ...
 <div className="rounded-xl border border-violet-100/70 bg-muted/40 p-5 text-center">
 ...
 <SectionCard icon={User} title="Personal Information" tint="bg-violet-50/80" onEdit={() => onEdit(1)}>
 ...
 <SectionCard icon={MapPin} title="Contact & Emergency" tint="bg-cyan-50/80" onEdit={() => onEdit(2)}>
 <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 sm:gap-x-8">
 <div className="font-medium text-stone-900">
 ...
 <SectionCard icon={Building2} title="Gym Setup" tint="bg-fuchsia-50/80" onEdit={() => onEdit(3)}>
 <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 sm:gap-x-8">
 <div className="font-medium text-stone-900">
 ...
 <SectionCard icon={Heart} title="Fitness & Health" tint="bg-emerald-50/80" onEdit={() => onEdit(4)}>
 <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 sm:gap-x-8">
 <div className="font-medium text-stone-900">
