...
const MEMBER_TYPES = [
 { value: "GYM", label: "Gym Only", description: "Access to gym facilities", tile: "bg-cyan-500" },
 { value: "PT", label: "Personal Training", description: "1-on-1 trainer sessions", tile: "bg-violet-600" },
 { value: "GYM_PT", label: "Gym + PT", description: "Full gym access + trainer sessions", tile: "bg-fuchsia-600" },
]
...
export function GymSetupStep({ data, onUpdate, onContinue, onBack }: GymSetupStepProps) {
 ...
 {/* Branch Selection */}
 <section aria-labelledby="gym-branch-heading" className="rounded-xl border border-violet-100/70 bg-card p-5">
 <h3 id="gym-branch-heading" className="flex items-center gap-2.5 font-semibold text-lg font-semibold tracking-tight text-stone-950">
 <span className="flex size-10 items-center justify-center rounded-xl bg-violet-600 text-white shadow-md shadow-violet-500/25">
 ...
 {/* Trainer Assignment */}
 <section aria-labelledby="gym-trainer-heading" className="rounded-xl border border-cyan-100/70 bg-card p-5">
 <h3 id="gym-trainer-heading" className="flex items-center gap-2.5 font-semibold text-lg font-semibold tracking-tight text-stone-950">
 <span className="flex size-10 items-center justify-center rounded-xl bg-cyan-500 text-white shadow-md shadow-cyan-500/25">
 ...
 {/* Member Type */}
 <section aria-labelledby="gym-type-heading" className="rounded-xl border border-fuchsia-100/70 bg-card p-5">
 <h3 id="gym-type-heading" className="flex items-center gap-2.5 font-semibold text-lg font-semibold tracking-tight text-stone-950">
 <span className="flex size-10 items-center justify-center rounded-xl bg-fuchsia-600 text-white shadow-md shadow-fuchsia-500/25">
 ...
 <span className={`mx-auto flex size-10 items-center justify-center rounded-xl text-white shadow-md ${type.tile}`} aria-hidden="true">
 ...
 {/* Fitness Goal */}
 <section aria-labelledby="gym-goal-heading" className="rounded-xl border border-emerald-100/70 bg-card p-5">
 <h3 id="gym-goal-heading" className="flex items-center gap-2.5 font-semibold text-lg font-semibold tracking-tight text-stone-950">
 <span className="flex size-10 items-center justify-center rounded-xl bg-emerald-500 text-white shadow-md shadow-emerald-500/25">
