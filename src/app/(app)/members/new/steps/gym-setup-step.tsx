...
export function GymSetupStep({ data, onUpdate, onContinue, onBack }: GymSetupStepProps) {
 ...
 return (
  <div className="flex flex-col gap-5">
   {/* Branch Selection */}
   <section aria-labelledby="gym-branch-heading" className="rounded-xl border border-violet-100/70 bg-white/60 p-5">
   ...
   {/* Trainer Assignment */}
   <section aria-labelledby="gym-trainer-heading" className="rounded-xl border border-cyan-100/70 bg-white/60 p-5">
   ...
   {/* Member Type */}
   <section aria-labelledby="gym-type-heading" className="rounded-xl border border-fuchsia-100/70 bg-white/60 p-5">
   ...
   {/* Fitness Goal */}
   <section aria-labelledby="gym-goal-heading" className="rounded-xl border border-emerald-100/70 bg-white/60 p-5">
