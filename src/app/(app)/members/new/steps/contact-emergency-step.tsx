...
export function ContactEmergencyStep({ data, onUpdate, onContinue, onBack }: ContactEmergencyStepProps) {
 ...
 return (
  <div className="flex flex-col gap-5">
   {/* Address Section */}
   <section aria-labelledby="contact-address-heading" className="overflow-hidden rounded-xl border border-cyan-100/70 bg-white/60">
   ...
   <section aria-labelledby="contact-emergency-heading" className="overflow-hidden rounded-xl border border-rose-100/70 bg-white/60">
