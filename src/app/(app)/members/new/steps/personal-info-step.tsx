...
export function PersonalInfoStep({ defaultValues, onUpdate, onContinue }: PersonalInfoStepProps) {
 ...
 return (
  <div className="flex flex-col gap-6">
   <div className="flex flex-col items-center gap-4 rounded-xl border border-violet-100/70 bg-gradient-to-br from-violet-50/70 via-white to-cyan-50/60 p-6">
    <div className="relative">
     {photoPreview ? (
      ...
      <div className="flex size-24 items-center justify-center rounded-xl border-2 border-dashed border-violet-200 bg-white/80 shadow-sm">
