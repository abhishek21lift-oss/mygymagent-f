  ...
  <Card className="overflow-hidden rounded-xl border-white/90 bg-white/88 shadow-xl shadow-violet-900/5 backdrop-blur-xl">
   <CardHeader className="flex flex-row items-start justify-between gap-4 border-b border-stone-100/80 bg-gradient-to-r from-violet-50/90 via-white to-cyan-50/70 px-5 py-5 sm:px-6">
    <div className="flex items-start gap-3">
     <span className="flex size-11 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-violet-600 to-fuchsia-600 text-white shadow-lg shadow-violet-500/25">
   ...
   <CardContent className="space-y-4 p-5 sm:p-6">
    {!insight && !error && (
     <div className="flex flex-col items-start gap-3 rounded-xl border border-violet-100/70 bg-gradient-to-br from-violet-50/70 via-white to-cyan-50/60 p-5 sm:flex-row sm:items-center sm:justify-between">
      <div>
    ...
    {error && (
     <div className="rounded-xl border border-rose-200 bg-gradient-to-r from-rose-50 to-orange-50 p-5 text-sm" role="alert">
    ...
    {insight && (
     <div className="rounded-xl border border-stone-200/70 bg-white/80 p-5 shadow-sm">
