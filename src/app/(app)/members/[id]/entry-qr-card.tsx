...
export function EntryQrCard({ memberId }: { memberId: string }) {
 ...
 return (
  <section
   ...
   className="overflow-hidden rounded-xl border border-white/90 bg-white/88 shadow-xl shadow-violet-900/5 backdrop-blur-xl dark:border-white/10 dark:bg-stone-950/80"
  >
