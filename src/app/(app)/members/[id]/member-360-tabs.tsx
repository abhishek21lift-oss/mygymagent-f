...
function InfoRow({ icon: Icon, label, value }: { icon: typeof User; label: string; value: React.ReactNode }) {
 return (
  <div className="flex items-start gap-3 rounded-xl border border-stone-200/70 bg-white/80 p-4 shadow-sm transition hover:border-violet-200 hover:shadow-md">
  ...
  <div className="flex flex-col gap-3">
   ...
   {!query.data || query.data.length === 0 ? (
    ...
    <div className="flex flex-col gap-2">
     {query.data.map((addr) => (
      <div key={addr.id} className="flex items-start justify-between rounded-xl border border-stone-200/70 bg-white/80 p-4 shadow-sm transition hover:border-violet-200 hover:shadow-md">
       <div>
        <div className="flex items-center gap-2">
   ...
   {!query.data || query.data.length === 0 ? (
    ...
    <div className="flex flex-col gap-2">
     {query.data.map((contact) => (
      <div key={contact.id} className="flex items-start justify-between rounded-xl border border-stone-200/70 bg-white/80 p-4 shadow-sm transition hover:border-violet-200 hover:shadow-md">
       <div>
        <div className="flex items-center gap-2">
 ...
 return (
  <div className="flex flex-col gap-3">
   ...
   {!query.data || query.data.length === 0 ? (
    ...
    <div className="flex flex-col gap-2">
     {query.data.map((note) => (
      <div key={note.id} className="flex items-start justify-between rounded-xl border border-stone-200/70 bg-white/80 p-4 shadow-sm transition hover:border-violet-200 hover:shadow-md">
       <div>
   ...
   {!query.data || query.data.length === 0 ? (
    ...
    <div className="flex flex-col gap-2">
     {query.data.map((consent) => (
      <div key={consent.id} className="flex items-center justify-between rounded-xl border border-stone-200/70 bg-white/80 p-4 shadow-sm transition hover:border-violet-200 hover:shadow-md">
       <div>
...
function HistoryPanel({ memberId }: { memberId: string }) {
 ...
 return (
  <div className="flex flex-col gap-2">
   {rows.map((row) => (
    <div key={row.id} className="flex items-center justify-between rounded-xl border border-stone-200/70 bg-white/80 p-4 shadow-sm transition hover:border-violet-200 hover:shadow-md text-sm">
     <span>{row.label}</span>
 ...
 return (
  <div className="flex flex-col gap-3">
   ...
   {!query.data || query.data.length === 0 ? (
    ...
    <div className="flex flex-col gap-2">
     {query.data.map((goal) => (
      <div key={goal.id} className="rounded-xl border border-stone-200/70 bg-white/80 p-4 shadow-sm">
 ...
 return (
  <div className="flex flex-col gap-3">
   ...
   {!query.data || query.data.length === 0 ? (
    ...
    <div className="flex flex-col gap-2">
     {query.data.map((doc) => (
      <div key={doc.id} className="flex flex-col gap-2 rounded-xl border border-stone-200/70 bg-white/80 p-4 shadow-sm">
 ...
 return (
  <div className="flex flex-col gap-3">
   {query.data.map((record) => (
    <div key={record.id} className="flex items-center justify-between rounded-xl border border-stone-200/70 bg-white/80 p-4 shadow-sm transition hover:border-violet-200 hover:shadow-md">
...
function OutstandingInvoicesBanner({ memberId, currency }: { memberId: string; currency: string }) {
 ...
 return (
  <div className="rounded-xl border border-amber-200/70 bg-gradient-to-br from-amber-50/90 to-white p-4 dark:border-amber-900/40 dark:from-amber-950/40 dark:to-stone-950">
 ...
 return (
  <div className="flex flex-col gap-4">
   ...
   <div className="grid grid-cols-2 gap-3 sm:grid-cols-5">
    <div className="rounded-xl border border-violet-200/60 bg-gradient-to-br from-violet-50/80 to-white p-3">
     <p className="text-xs font-black uppercase tracking-[.16em] text-stone-500">Total</p>
    ...
    <div className="rounded-xl border border-stone-200/70 bg-white/80 p-3">
     <p className="text-xs font-black uppercase tracking-[.16em] text-stone-500">Discounts</p>
     <p className="font-mono text-lg font-black tabular-nums text-stone-500">
      -{currency} {totalDiscounts.toLocaleString()}
     </p>
    </div>
    <div className="rounded-xl border border-cyan-200/60 bg-gradient-to-br from-cyan-50/80 to-white p-3">
     <p className="text-xs font-black uppercase tracking-[.16em] text-stone-500">Final</p>
     <p className="font-mono text-lg font-black tabular-nums text-stone-950">
      {currency} {finalAmount.toLocaleString()}
     </p>
    </div>
    <div className="rounded-xl border border-emerald-200/60 bg-gradient-to-br from-emerald-50/80 to-white p-3">
     <p className="text-xs font-black uppercase tracking-[.16em] text-stone-500">Paid</p>
     <p className="font-mono text-lg font-black tabular-nums text-emerald-700">
      {currency} {totalPaid.toLocaleString()}
     </p>
    </div>
    <div className="rounded-xl border border-amber-200/60 bg-gradient-to-br from-amber-50/80 to-white p-3">
    ...
    <div>
     ...
     <div className="flex flex-col gap-2">
      {memberships.map((membership) => (
       <div key={membership.id} className="flex items-center justify-between rounded-xl border border-stone-200/70 bg-white/80 p-4 shadow-sm transition hover:border-violet-200 hover:shadow-md">
        <div className="flex items-center gap-3">
         <div className="flex size-9 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-violet-600 to-cyan-500 text-white shadow-md shadow-violet-500/20">
      ...
      {payments.map((payment) => {
       ...
       const statusVariant =
        payment.status === "COMPLETED"
         ...
         : "secondary";
       return (
        <div key={payment.id} className="flex items-center justify-between rounded-xl border border-stone-200/70 bg-white/80 p-4 shadow-sm transition hover:border-violet-200 hover:shadow-md">
         <div className="flex items-center gap-3">
          <div className="flex size-9 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-violet-600 to-cyan-500 text-white shadow-md shadow-violet-500/20">
...
function ScreeningPanel({ memberId }: { memberId: string }) {
 ...
 return (
  <div className="flex flex-col gap-4">
   ...
   {latestScreening ? (
    <div className="rounded-xl border border-stone-200/70 bg-white/80 p-4 shadow-sm transition hover:border-violet-200 hover:shadow-md">
     <div className="flex items-center justify-between">
      <div>
 ...
 return (
  <div className="flex flex-col gap-2">
   {query.data.map((assignment) => (
    <div key={assignment.id} className="rounded-xl border border-stone-200/70 bg-white/80 p-4 shadow-sm transition hover:border-violet-200 hover:shadow-md">
     <div className="flex items-center justify-between">
      <div>
 ...
 return (
  <div className="flex flex-col gap-2">
   {query.data.map((session) => (
    <div key={session.id} className="rounded-xl border border-stone-200/70 bg-white/80 p-4 shadow-sm transition hover:border-violet-200 hover:shadow-md">
     <div className="flex items-center justify-between">
      <div className="flex items-center gap-3">
     ...
     {openFollowUps.length > 0 && (
      <div className="flex flex-col gap-2">
       ...
       {openFollowUps.map((followUp) => (
        <div key={followUp.id} className="flex items-start justify-between rounded-xl border border-stone-200/70 bg-white/80 p-4 shadow-sm transition hover:border-violet-200 hover:shadow-md">
 ...
 return (
  <div className="flex flex-col gap-3">
   ...
   {!query.data || query.data.length === 0 ? (
    ...
    <div className="flex flex-col gap-2">
     {query.data.map((msg) => (
      <div key={msg.id} className="flex items-start gap-3 rounded-xl border border-stone-200/70 bg-white/80 p-4 shadow-sm">
  ...
  <div className="flex flex-col gap-4">
   <div className="flex flex-col gap-2">
    {data.events.map((event) => {
     ...
     return (
      <div key={event.id} className="flex items-start gap-3 rounded-xl border border-stone-200/70 bg-white/80 p-4 shadow-sm">
       <div className="flex size-9 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-violet-600 to-cyan-500 text-white shadow-md shadow-violet-500/20">
  ...
  <div className="flex flex-col gap-4">
   ...
   <div className="flex flex-col gap-2">
    {data.potentialDuplicates.map((dup) => (
     <div key={dup.memberId} className="flex items-center justify-between rounded-xl border border-stone-200/70 bg-white/80 p-4 shadow-sm transition hover:border-violet-200 hover:shadow-md">
      <div className="flex items-center gap-3">
 ...
 return (
  <Tabs defaultValue="overview" className="w-full">
   <div className="relative -mx-1 px-1">
    <TabsList className="h-auto w-full justify-start overflow-x-auto rounded-xl border border-violet-100/70 bg-gradient-to-r from-violet-50/70 via-white to-cyan-50/70 p-1.5 shadow-sm">
     <TabsTrigger
      value="overview"
