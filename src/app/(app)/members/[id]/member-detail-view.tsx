...
function ProgressStat({
 ...
 return (
  <div className="group relative overflow-hidden rounded-xl border border-stone-200/70 bg-white/80 p-4 transition-all duration-200 hover:-translate-y-px hover:shadow-md">
    ...
    <Form {...form}>
     <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
      <Tabs defaultValue="personal" className="w-full">
       <TabsList className="grid h-auto w-full grid-cols-5 rounded-lg border border-violet-100/70 bg-gradient-to-r from-violet-50/80 via-white to-cyan-50/70 p-1.5">
  ...
  <section aria-label="Member quick stats" className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
   <Card className="group relative overflow-hidden border-white/90 bg-white/85 shadow-[0_20px_60px_-38px_rgba(79,70,229,.35)] backdrop-blur-xl transition duration-300 hover:-translate-y-1">
    ...
    <CardContent className="flex items-center gap-4 p-5">
     <div className="flex size-14 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-emerald-500 to-teal-600 text-white shadow-lg shadow-emerald-500/30 transition-transform duration-300 group-hover:scale-110">
   ...
   <Card className="group relative overflow-hidden border-white/90 bg-white/85 shadow-[0_20px_60px_-38px_rgba(79,70,229,.35)] backdrop-blur-xl transition duration-300 hover:-translate-y-1">
    ...
    <CardContent className="flex items-center gap-4 p-5">
     <div className="flex size-14 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-cyan-500 to-blue-600 text-white shadow-lg shadow-cyan-500/30 transition-transform duration-300 group-hover:scale-110">
   ...
   <Card className="group relative overflow-hidden border-white/90 bg-white/85 shadow-[0_20px_60px_-38px_rgba(79,70,229,.35)] backdrop-blur-xl transition duration-300 hover:-translate-y-1">
    ...
    <CardContent className="flex items-center gap-4 p-5">
     <div className="flex size-14 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-violet-600 to-fuchsia-600 text-white shadow-lg shadow-violet-500/30 transition-transform duration-300 group-hover:scale-110">
   ...
   <Card className="group relative overflow-hidden border-white/90 bg-white/85 shadow-[0_20px_60px_-38px_rgba(79,70,229,.35)] backdrop-blur-xl transition duration-300 hover:-translate-y-1">
    ...
    <CardContent className="flex items-center gap-4 p-5">
     <div className="flex size-14 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-amber-500 to-orange-600 text-white shadow-lg shadow-amber-500/30 transition-transform duration-300 group-hover:scale-110">
...
export function MemberDetailView({ memberId }: { memberId: string }) {
 ...
 return (
  <div className="flex flex-col gap-8">
   ...
   {/* AI Progress Card */}
   <Card className="overflow-hidden rounded-xl border-white/90 bg-white/88 p-0 shadow-xl shadow-violet-900/5 backdrop-blur-xl">
   ...
   {/* Tabbed Content */}
   <Card className="overflow-hidden rounded-xl border-white/90 bg-white/88 shadow-xl shadow-violet-900/5 backdrop-blur-xl">
