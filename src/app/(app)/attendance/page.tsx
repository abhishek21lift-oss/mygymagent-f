...
function CheckInForm() {
 ...
 className={
 gate.ok
 ? "rounded-lg border border-emerald-200/80 bg-emerald-50 px-4 py-3 text-sm font-bold text-emerald-800 dark:border-emerald-900/60 dark:bg-emerald-950/50 dark:text-emerald-200"
 : "rounded-lg border border-rose-200/80 bg-rose-50 px-4 py-3 text-sm font-bold text-rose-800 dark:border-rose-900/60 dark:bg-rose-950/50 dark:text-rose-200"
 }
 >
 {gate.text}
 </p>
