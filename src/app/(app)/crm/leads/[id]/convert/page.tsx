  ...
  <div className="relative -mx-2 min-h-full overflow-hidden pb-12 sm:-mx-3 lg:-mx-5">
   ...
   <div className="mx-auto flex max-w-[1680px] flex-col gap-8 px-2 sm:px-4 lg:px-6">
    ...
    <div className="grid gap-5 lg:grid-cols-[1fr_0.85fr]">
     <Card className="overflow-hidden rounded-xl border border-white/90 bg-white/88 shadow-xl shadow-violet-900/5 backdrop-blur-xl">
      <div className="flex items-center gap-3 border-b border-stone-100/80 bg-gradient-to-r from-blue-50/90 via-white to-cyan-50/60 px-5 py-5 sm:px-6">
       <span className="flex size-11 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-emerald-500 to-teal-600 text-white shadow-md shadow-emerald-500/25">
      ...
      <CardContent className="space-y-6 p-5 sm:p-6">
       <div className="flex items-start gap-3 rounded-xl border border-blue-100/70 bg-gradient-to-br from-blue-50/70 via-white to-violet-50/50 p-5">
        <span className="flex size-12 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-blue-600 to-violet-600 text-white shadow-lg shadow-blue-500/25">
     ...
     <aside aria-label="What happens next" className="relative flex h-full flex-col overflow-hidden rounded-xl bg-[linear-gradient(145deg,#172554,#3730a3_45%,#a21caf)] p-4 text-white shadow-[0_28px_75px_-38px_rgba(79,70,229,.78)] sm:p-5">
      ...
      <ul className="relative mt-6 space-y-3 text-sm">
       <li className="rounded-lg border border-white/15 bg-white/10 p-4 backdrop-blur">
