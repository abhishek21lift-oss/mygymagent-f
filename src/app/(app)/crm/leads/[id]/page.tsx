 ...
 return (
  <div className="relative -mx-2 min-h-full overflow-hidden pb-12 sm:-mx-3 lg:-mx-5">
   ...
   <div className="mx-auto flex max-w-[1680px] flex-col gap-8 px-2 sm:px-4 lg:px-6">
     ...
     <div className="overflow-hidden rounded-xl border border-white/90 bg-white/88 shadow-xl shadow-violet-900/5 backdrop-blur-xl">
      ...
      <div className="space-y-5 p-5 sm:p-6">
       ...
       <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-1">
        <div className="rounded-xl border border-blue-100/70 bg-gradient-to-br from-blue-50/70 to-cyan-50/40 p-4">
    ...
    <section aria-labelledby="lead-followups" className="overflow-hidden rounded-xl border border-white/90 bg-white/88 shadow-xl shadow-violet-900/5 backdrop-blur-xl">
     <div className="flex items-center gap-3 border-b border-stone-100/80 bg-gradient-to-r from-cyan-50/90 via-white to-violet-50/60 px-5 py-5 sm:px-6">
      <span className="flex size-11 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-cyan-500 to-violet-600 text-white shadow-md shadow-cyan-500/25">
     ...
     <div className="space-y-5 p-5 sm:p-6">
      ...
      <div className="space-y-3">
       {currentLead.followUps?.map((followUp) => (
        <div key={followUp.id} className="flex flex-col gap-3 rounded-xl border border-white/90 bg-white/80 p-4 shadow-sm transition hover:shadow-md sm:flex-row sm:items-center sm:justify-between">
