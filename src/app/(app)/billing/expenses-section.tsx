 ...
 return (
  <section aria-labelledby="expenses-title" className="flex flex-col gap-4">
   <div className="grid gap-4 sm:grid-cols-2">
    <div className="group relative overflow-hidden rounded-xl border border-white/90 bg-white/85 shadow-[0_20px_60px_-38px_rgba(79,70,229,.35)] backdrop-blur-xl transition duration-300 hover:-translate-y-1 dark:border-white/10 dark:bg-stone-950/80">
     ...
     <CardContent className="relative flex items-center gap-4 p-5 lg:p-6">
      <span className="flex size-14 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-emerald-500 to-teal-600 text-white shadow-lg shadow-emerald-500/30 transition-transform duration-300 group-hover:scale-110 group-hover:-rotate-3"><Wallet className="size-6" aria-hidden="true" /></span>
    ...
    <div className="group relative overflow-hidden rounded-xl border border-white/90 bg-white/85 shadow-[0_20px_60px_-38px_rgba(79,70,229,.35)] backdrop-blur-xl transition duration-300 hover:-translate-y-1 dark:border-white/10 dark:bg-stone-950/80">
     ...
     <CardContent className="relative flex items-center gap-4 p-5 lg:p-6">
      <span className="flex size-14 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-amber-500 to-orange-600 text-white shadow-lg shadow-amber-500/30 transition-transform duration-300 group-hover:scale-110 group-hover:-rotate-3"><Receipt className="size-6" aria-hidden="true" /></span>
      <div className="min-w-0 flex-1">
   ...
   <div className="overflow-hidden rounded-xl border border-white/90 bg-white/88 shadow-xl shadow-violet-900/5 backdrop-blur-xl dark:border-white/10 dark:bg-stone-950/80">
