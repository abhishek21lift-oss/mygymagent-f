...
function AgingChips() {
 ...
 if (aging.isLoading) {
 return <div className="h-12 animate-pulse rounded-lg bg-stone-200/70 dark:bg-card" aria-label="Loading aging" />;
 }
 ...
 <span key={label} className={`inline-flex min-h-11 items-center gap-1.5 rounded-lg border px-3 py-1.5 text-sm font-bold tabular-nums ${tone}`}>
