...
export function RaiseInvoiceDialog() {
 ...
 <div key={field.id} className="grid grid-cols-1 gap-2 rounded-lg border border-stone-200/70 p-3 sm:grid-cols-[1fr_110px_70px_44px] sm:items-end dark:border-white/10">
 <div>
