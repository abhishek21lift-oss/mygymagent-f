   ...
   <div className="mx-auto flex max-w-[1680px] flex-col gap-8 px-2 sm:px-4 lg:px-6">
    ...
    <section aria-labelledby="branches-grid-title" className="">
     ...
     {branchesQuery.isLoading ? (
      ...
      <div className="overflow-hidden rounded-xl border border-white/90 bg-white/88 p-4 shadow-xl backdrop-blur-xl dark:border-white/10 dark:bg-stone-950/80">
         ...
         <article key={branch.id} className="group relative flex flex-col overflow-hidden rounded-xl border border-white/90 bg-white/88 shadow-[0_20px_60px_-38px_rgba(79,70,229,.35)] backdrop-blur-xl transition duration-300 hover:-translate-y-1 hover:shadow-[0_28px_70px_-38px_rgba(79,70,229,.42)] dark:border-white/10 dark:bg-stone-950/80">
          ...
          <div className="flex flex-row items-center justify-between gap-3 px-5 pt-5 sm:px-6">
           <div className="flex min-w-0 items-center gap-3">
            <span className={`flex size-11 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br text-white shadow-md transition-transform duration-300 group-hover:scale-110 group-hover:-rotate-3 ${tile}`}>
