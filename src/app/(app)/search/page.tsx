...
export default function SearchPage() {
  ...
  return <main className="space-y-8"><PageHero eyebrow="Workspace" title="Global Search" description="Find members, leads, products and invoices from one place." icon={SearchIcon} />
