...
import { ArrowRight, BadgeCheck, Clock3, Layers, Plus, Sparkles, Tag, Wallet } from "lucide-react";
  ...
  return (
    <div className="relative -mx-2 min-h-full overflow-hidden pb-12 sm:-mx-3 lg:-mx-5">
      ...
      <div className="mx-auto flex max-w-[1680px] flex-col gap-8 px-2 sm:px-4 lg:px-6">
        <section aria-labelledby="plans-title" className="relative overflow-hidden rounded-[34px] border border-white/90 bg-white/88 p-6 shadow-[0_35px_110px_-48px_rgba(79,70,229,.48)] backdrop-blur-2xl sm:p-8 lg:p-10 dark:border-white/10 dark:bg-stone-950/80">
          ...
          <div className="relative flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="min-w-0 flex-1">
              <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-emerald-200/70 bg-emerald-50/80 px-3 py-1.5 text-[10px] font-black uppercase tracking-[.18em] text-emerald-800">
                <Layers className="size-3.5" aria-hidden="true" /> Plan catalog
              </div>
              <h1 id="plans-title" className="font-serif text-4xl font-semibold tracking-[-.045em] text-stone-950 sm:text-5xl lg:text-6xl dark:text-white">Membership Plans</h1>
              <p className="mt-3 max-w-2xl text-sm font-medium leading-6 text-stone-600 dark:text-stone-400">Plans members can subscribe to — price, duration and freeze policy in one vivid catalog.</p>
            </div>
