 ...
 return (
  ...
  >
   ...
   <CardContent className="relative flex items-center gap-4 p-5 lg:p-6">
    <span
     className={`flex size-14 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br text-white shadow-lg ${t.tile} transition-transform duration-300 group-hover:scale-110 group-hover:-rotate-3`}
    >
...
function PriorityRow({
 ...
 return (
  ...
  >
   ...
   <span
    className={`flex size-11 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br text-white shadow-md transition-transform duration-200 group-hover/pri:scale-110 ${s.chip}`}
   >
...
function WatchlistCard({
 ...
 return (
  <Card className="overflow-hidden border-white/90 bg-white/88 shadow-xl shadow-violet-900/5 backdrop-blur-xl">
   ...
   >
    <span
     className={`flex size-11 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br text-white shadow-md ${w.tile}`}
    >
     <Icon className="size-5" aria-hidden="true" />
    </span>
    <div className="min-w-0 flex-1">
...
function Shortcut({
 ...
 return (
  <Link
   href={href}
   className={`group/sc flex min-h-11 flex-col gap-3 rounded-xl border border-white/90 bg-white/85 p-4 shadow-[0_16px_45px_-30px_rgba(79,70,229,.4)] backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_24px_55px_-30px_rgba(79,70,229,.5)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-violet-600 ${hoverRing}`}
  >
   <span
    className={`flex size-11 items-center justify-center rounded-lg bg-gradient-to-br text-white shadow-md transition-transform duration-300 group-hover/sc:scale-110 group-hover/sc:-rotate-3 ${tile}`}
   >
    <Icon className="size-5" aria-hidden="true" />
   </span>
   <span>
  ...
  <div className="relative -mx-2 min-h-full overflow-hidden pb-12 sm:-mx-3 lg:-mx-5">
   ...
   <div className="mx-auto flex max-w-[1680px] flex-col gap-8 px-2 sm:px-4 lg:px-6">
    ...
    {briefing.isError && (
     <div
      role="alert"
      className="flex flex-col gap-3 rounded-xl border border-rose-200 bg-gradient-to-r from-rose-50 to-orange-50 p-5 sm:flex-row sm:items-center"
     >
      <span className="flex size-11 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-rose-500 to-orange-500 text-white shadow-md">
    ...
    >
     <Card className="overflow-hidden border-white/90 bg-white/88 shadow-xl shadow-violet-900/5 backdrop-blur-xl">
      <div className="flex items-center justify-between gap-3 border-b border-stone-100/80 bg-gradient-to-r from-white via-violet-50/50 to-cyan-50/50 px-6 py-5">
       <div className="flex items-center gap-3">
        <span className="flex size-11 items-center justify-center rounded-lg bg-gradient-to-br from-violet-600 to-fuchsia-600 text-white shadow-lg shadow-violet-500/25">
      ...
      <CardContent className="p-3 sm:p-4">
       {briefing.isLoading ? (
        <div className="space-y-2" aria-label="Loading priorities">
         {[1, 2, 3].map((item) => (
          <div key={item} className="h-[68px] animate-pulse rounded-xl bg-gradient-to-r from-stone-100 to-stone-50" />
         ))}
        </div>
       ) : priorities.length ? (
        ...
        <div className="flex flex-col items-center justify-center gap-2 rounded-xl border border-dashed border-emerald-200 bg-gradient-to-br from-emerald-50/80 to-teal-50/50 px-5 py-10 text-center">
     ...
     <div className="relative flex h-full flex-col overflow-hidden rounded-xl bg-[linear-gradient(145deg,#172554,#3730a3_45%,#a21caf)] p-4 text-white shadow-[0_28px_75px_-38px_rgba(79,70,229,.78)] sm:p-5">
      ...
      <div className="relative flex items-center gap-3">
       <span className="flex size-11 items-center justify-center rounded-lg bg-white/15 ring-1 ring-white/20 backdrop-blur">
    ...
    <section aria-labelledby="cc-money" className="[animation-delay:150ms]">
     <div className="mb-4 flex items-end justify-between gap-4">
      <div className="flex items-center gap-3">
       <span className="flex size-11 items-center justify-center rounded-lg bg-gradient-to-br from-emerald-500 to-teal-600 text-white shadow-lg shadow-emerald-500/25">
      ...
      {(
       ...
       >
        ...
        <CardContent className="flex items-center gap-4 p-5 lg:p-6">
         <span className={`flex size-14 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br text-white shadow-lg ${item.tile}`}>
     ...
     <Link
      href="/billing"
      className="group/collect mt-4 flex items-center gap-4 rounded-xl border border-amber-200/80 bg-gradient-to-r from-amber-50 via-orange-50/70 to-yellow-50/60 px-5 py-4 shadow-sm transition-all duration-200 hover:-translate-y-px hover:shadow-md focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-600 lg:px-6"
     >
      <span className="flex size-12 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-amber-500 to-orange-600 text-white shadow-lg shadow-amber-500/25">
       <CreditCard className="size-5" aria-hidden="true" />
      </span>
      <span className="min-w-0 flex-1">
    ...
    <section aria-labelledby="cc-fast" className="[animation-delay:250ms]">
     <div className="mb-4 flex items-center gap-3">
      <span className="flex size-11 items-center justify-center rounded-lg bg-gradient-to-br from-cyan-500 via-violet-600 to-fuchsia-600 text-white shadow-lg shadow-violet-500/25">
       <Zap className="size-5" aria-hidden="true" />
      </span>
      <div>
