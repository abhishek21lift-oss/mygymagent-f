   ...
   <div className="mx-auto flex max-w-[1680px] flex-col gap-8 px-2 sm:px-4 lg:px-6">
    ...
    <section aria-labelledby="inventory-pulse" className="">
     ...
     <div className="grid gap-4 sm:grid-cols-2">
      <div className="group relative overflow-hidden rounded-xl border border-white/90 bg-white/85 shadow-[0_20px_60px_-38px_rgba(79,70,229,.35)] backdrop-blur-xl transition duration-300 hover:-translate-y-1 hover:border-amber-200 hover:shadow-amber-500/10 dark:border-white/10 dark:bg-stone-950/80">
       ...
       <div className="relative flex items-center gap-4 p-5 lg:p-6">
        <span className="flex size-14 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-amber-500 to-orange-600 text-white shadow-lg shadow-amber-500/30 transition-transform duration-300 group-hover:scale-110 group-hover:-rotate-3">
      ...
      <div className={`group relative overflow-hidden rounded-xl border bg-white/85 shadow-[0_20px_60px_-38px_rgba(79,70,229,.35)] backdrop-blur-xl transition duration-300 hover:-translate-y-1 dark:bg-stone-950/80 ${lowStockCount > 0 ? "border-amber-300/80 hover:border-amber-300 hover:shadow-amber-500/15" : "border-white/90 hover:border-emerald-200 hover:shadow-emerald-500/10 dark:border-white/10"}`}>
       ...
       <div className="relative flex items-center gap-4 p-5 lg:p-6">
        <span className={`flex size-14 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br text-white shadow-lg transition-transform duration-300 group-hover:scale-110 group-hover:-rotate-3 ${lowStockCount > 0 ? "from-amber-500 to-orange-600 shadow-amber-500/30" : "from-emerald-500 to-teal-600 shadow-emerald-500/30"}`}>
    ...
    <section aria-labelledby="inventory-products" className="overflow-hidden rounded-xl border border-white/90 bg-white/88 shadow-xl shadow-violet-900/5 backdrop-blur-xl dark:border-white/10 dark:bg-stone-950/80">
     <div className="flex items-center gap-3 border-b border-stone-100/80 bg-gradient-to-r from-amber-50/90 via-white to-orange-50/60 px-5 py-5 sm:px-6 dark:from-amber-950/30 dark:via-stone-950 dark:to-orange-950/20">
      <span className="flex size-11 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-amber-500 to-orange-600 text-white shadow-lg shadow-amber-500/25">
    ...
    <section aria-labelledby="inventory-movements" className="overflow-hidden rounded-xl border border-white/90 bg-white/88 shadow-xl shadow-violet-900/5 backdrop-blur-xl dark:border-white/10 dark:bg-stone-950/80">
     <div className="flex items-center justify-between gap-3 border-b border-stone-100/80 bg-gradient-to-r from-orange-50/90 via-white to-yellow-50/60 px-5 py-5 sm:px-6 dark:from-orange-950/30 dark:via-stone-950 dark:to-yellow-950/10">
      <div className="flex items-center gap-3">
       <span className="flex size-11 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-orange-500 to-amber-500 text-white shadow-lg shadow-orange-500/25">
