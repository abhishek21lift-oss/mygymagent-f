...
export default function NewInventoryProductPage() {
 ...
 <div className="overflow-hidden rounded-lg border border-amber-200/70 bg-muted/40 p-5 shadow-[0_24px_70px_-48px_rgba(245,158,11,.55)] dark:border-amber-500/20 dark:from-amber-950/30 dark:via-stone-950 dark:to-orange-950/20">
 <div className="flex size-12 items-center justify-center rounded-lg bg-amber-500 text-white shadow-lg shadow-amber-500/25">
