...
function Assignment({ item }: { item: DietAssignment }) {
 ...
 return (
  <div className="group flex flex-col gap-3 rounded-xl border border-stone-200/80 bg-white/70 p-4 transition duration-200 hover:-translate-y-0.5 hover:border-emerald-200 hover:bg-white hover:shadow-[0_20px_50px_-30px_rgba(16,185,129,.45)] sm:flex-row sm:items-center">
  ...
  <div className="relative -mx-2 min-h-full overflow-hidden pb-12 sm:-mx-3 lg:-mx-5">
   ...
   <div className="mx-auto flex max-w-[1680px] flex-col gap-8 px-2 sm:px-4 lg:px-6">
    ...
    <section aria-label="Plans" className="grid gap-5">
     <Card className="overflow-hidden rounded-xl border-white/90 bg-white/88 shadow-xl shadow-emerald-900/5 backdrop-blur-xl">
      <div className="flex items-start gap-3 border-b border-stone-100/80 bg-gradient-to-r from-emerald-50/90 via-white to-lime-50/60 px-5 py-5">
       <span className="flex size-11 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-emerald-500 to-lime-500 text-white shadow-md shadow-emerald-500/25" aria-hidden="true">
       ...
       {plans.isError ? (
        ...
        <div className="grid gap-3 sm:grid-cols-2">
         {plans.data?.items.map((plan) => (
          <div key={plan.id} className="group rounded-xl border border-stone-200/80 bg-white/70 p-4 transition duration-200 hover:-translate-y-1 hover:border-emerald-200 hover:shadow-[0_20px_50px_-30px_rgba(16,185,129,.45)]">
    ...
    <Card className="overflow-hidden rounded-xl border-white/90 bg-white/85 shadow-lg backdrop-blur-xl">
     <div className="flex items-start gap-3 border-b border-stone-100/80 bg-gradient-to-r from-lime-50/80 via-white to-emerald-50/60 px-5 py-5">
      <span className="flex size-11 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-lime-500 to-emerald-600 text-white shadow-md shadow-lime-500/25" aria-hidden="true">
