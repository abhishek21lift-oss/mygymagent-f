    ...
    <PageHero
     ...
     actions={
      <div className="flex items-center gap-3 rounded-2xl border border-orange-100 bg-gradient-to-r from-rose-50 to-orange-50 px-4 py-3 text-xs font-bold text-stone-700">
       <span className="flex size-11 items-center justify-center rounded-lg bg-gradient-to-br from-rose-500 to-orange-500 text-white shadow-md shadow-rose-500/25" aria-hidden="true">
    ...
    <section aria-label="Execution workspace" className="grid gap-5 xl:grid-cols-[.9fr_1.35fr]">
        ...
        <div>
         ...
         <div className="space-y-2">
          {activeAssignments.map((a) => (
           <div key={a.id} className="group flex items-center gap-3 rounded-xl border border-stone-200/80 bg-white/70 p-3 transition duration-200 hover:-translate-y-px hover:border-rose-200 hover:bg-rose-50/50 hover:shadow-md">
     ...
     <Card className="overflow-hidden rounded-xl border-white/90 bg-white/88 shadow-xl shadow-cyan-900/5 backdrop-blur-xl">
      ...
      <CardContent className="p-4 sm:p-5">
       {!selectedId ? (
        <div className="flex min-h-64 flex-col items-center justify-center rounded-xl border border-dashed border-rose-200 bg-gradient-to-br from-rose-50/70 to-orange-50/50 p-8 text-center">
        ...
        <div className="space-y-4">
         <div className="rounded-xl bg-gradient-to-br from-rose-50 via-orange-50/70 to-cyan-50/60 p-4 ring-1 ring-rose-100">
         ...
         {selected.data.exercises.map((exercise) => {
          ...
          return (
           <div key={exercise.id} className="rounded-xl border border-stone-200/80 bg-white/70 p-4 transition hover:border-orange-200 hover:shadow-md">
