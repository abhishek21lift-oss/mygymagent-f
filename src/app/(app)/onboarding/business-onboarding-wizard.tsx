...
function FeatureCard({
 ...
 return (
  <div className="flex items-start gap-3 rounded-xl border border-stone-200/70 bg-white/70 p-4 text-left transition hover:-translate-y-0.5 hover:border-violet-200 hover:shadow-md">
   <div className={`flex size-11 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br text-white shadow-md ${tile}`}>
...
function StepHeading({ icon: Icon, tile, title, subtitle }: { icon: typeof Building2; tile: string; title: string; subtitle: string }) {
 return (
  <div className="text-center">
   <div className={`mb-4 inline-flex size-14 items-center justify-center rounded-lg bg-gradient-to-br text-white shadow-lg ${tile}`}>
 ...
 return (
  <div className="mx-auto max-w-xl">
   ...
   <div className="mt-8 flex flex-col gap-5">
    ...
    <div className="rounded-xl border border-violet-100 bg-gradient-to-br from-violet-50/80 to-fuchsia-50/50 p-4">
     <div className="flex items-start gap-3">
      <div className="flex size-11 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-violet-600 to-fuchsia-600 text-white shadow-md">
  ...
  <div className="mx-auto max-w-xl">
   ...
   <div className="mt-8 flex flex-col gap-5">
    ...
    <div className="rounded-xl border border-emerald-100 bg-gradient-to-br from-emerald-50/80 to-teal-50/50 p-4">
     <div className="flex items-start gap-3">
      <div className="flex size-11 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-emerald-500 to-teal-600 text-white shadow-md">
...
function CompleteStep() {
 ...
 return (
  <div className="flex flex-col items-center text-center">
   <div className="mb-6 flex size-24 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 shadow-[0_20px_50px_-20px_rgba(16,185,129,.6)]">
