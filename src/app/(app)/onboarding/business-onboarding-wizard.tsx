...
function ProgressIndicator({ currentStep }: { currentStep: number }) {
 ...
 <p className="mt-0.5 text-xs font-medium text-stone-600">{step.description}</p>
 </div>
 </div>
 ))}
 </div>
...
function WelcomeStep({ onUpdate }: { onUpdate: (data: Partial<OnboardingData>) => void }) {
 ...
 <h2 className="font-semibold text-3xl font-semibold tracking-tight text-stone-950">Welcome to THE CULT CLIENT</h2>
...
function FeatureCard({
 ...
 return (
 <div className="flex items-start gap-3 rounded-xl border border-stone-200/70 bg-card p-4 text-left transition hover:-translate-y-0.5 hover:border-violet-200 hover:shadow-md">
 <div className={`flex size-11 shrink-0 items-center justify-center rounded-lg text-white shadow-md ${tile}`}>
...
function BusinessStep({
 ...
 <StepHeading icon={Building2} tile="bg-violet-600 shadow-violet-500/25" title="Business Details" subtitle="Tell us about your gym or fitness business" />
...
function BranchStep({
 ...
 return (
 <div className="mx-auto max-w-xl">
 <StepHeading icon={MapPin} tile="bg-cyan-500 shadow-cyan-500/25" title="Branch Location" subtitle="Set up your primary gym location" />
...
function ConfigurationStep({
 ...
 return (
 <div className="mx-auto max-w-xl">
 <StepHeading icon={Settings} tile="bg-amber-500 shadow-amber-500/25" title="Configuration" subtitle="Set your preferences and defaults" />
 ...
 <div className="rounded-xl border border-violet-100 bg-muted/40 p-4">
 <div className="flex items-start gap-3">
 <div className="flex size-11 shrink-0 items-center justify-center rounded-lg bg-violet-600 text-white shadow-md">
...
function TeamStep({
 ...
 return (
 <div className="mx-auto max-w-xl">
 <StepHeading icon={Users} tile="bg-emerald-500 shadow-emerald-500/25" title="Invite Your Team" subtitle="Add trainers and staff members (optional, you can skip this)" />
 ...
 className="min-h-11 rounded-xl"
 />
 <Button variant="outline" onClick={addEmail} className="min-h-11 rounded-xl border-stone-200 bg-card">
 Add
 </Button>
 </div>
 <p className="text-xs font-medium text-stone-600">
 ...
 variant="ghost"
 size="icon"
 className="ml-2 size-6 rounded-md text-xs"
 ...
 <div className="rounded-xl border border-emerald-100 bg-muted/40 p-4">
 <div className="flex items-start gap-3">
 <div className="flex size-11 shrink-0 items-center justify-center rounded-lg bg-emerald-500 text-white shadow-md">
...
function CompleteStep() {
 ...
 return (
 <div className="flex flex-col items-center text-center">
 <div className="mb-6 flex size-24 items-center justify-center rounded-xl bg-emerald-500 shadow-[0_20px_50px_-20px_rgba(16,185,129,.6)]">
 <CheckCircle2 className="size-12 text-white" aria-hidden="true" />
 </div>
 <h2 className="font-semibold text-3xl font-semibold tracking-tight text-stone-950">Your Gym is Ready!</h2>
 <p className="mt-3 max-w-md text-sm font-medium leading-6 text-stone-600">
...
function ReviewStep({
 ...
 return (
 <div className="mx-auto max-w-xl">
 <StepHeading icon={CheckCircle2} tile="bg-violet-600 shadow-violet-500/25" title="Review & Launch" subtitle="Here's what we'll set up for you" />
 ...
 <Button variant="outline" onClick={onBack} disabled={isSubmitting} className="min-h-11 rounded-lg">
...
function ReviewCard({
 ...
 <span className="flex size-9 items-center justify-center rounded-xl bg-violet-600 text-white shadow-md">
...
export function BusinessOnboardingWizard() {
 ...
 <Button variant="outline" onClick={goBack} className="min-h-11 rounded-lg border-stone-200 bg-card">
 <ChevronLeft className="mr-2 size-4" aria-hidden="true" />
 Back
 </Button>
