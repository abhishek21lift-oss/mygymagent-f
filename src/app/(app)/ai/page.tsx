    ...
    {notConfigured ? (
     <Card className="overflow-hidden border-white/90 bg-white/88 shadow-xl backdrop-blur-xl">
      <CardContent className="flex flex-col items-center gap-2 px-6 py-14 text-center">
       <span className="flex size-14 items-center justify-center rounded-lg bg-gradient-to-br from-violet-600 to-fuchsia-600 text-white shadow-lg shadow-violet-500/30">
     ...
     <div className="grid gap-5 xl:grid-cols-[1fr_320px]">
      <section aria-label="Conversation" className="flex min-h-[480px] flex-col overflow-hidden rounded-xl border border-white/90 bg-white/88 shadow-xl shadow-violet-900/5 backdrop-blur-xl">
         ...
         <div className="flex flex-col gap-4">
          {messages.map((m, i) => (
           ...
           >
            <div
             className={cn(
              "max-w-[80%] rounded-xl px-4 py-3 text-sm leading-6 shadow-sm",
              m.role === "user"
