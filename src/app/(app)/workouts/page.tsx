...
function AssignmentRow({ assignment }: { assignment: WorkoutAssignment }) {
 ...
 return (
  <div className="group flex flex-col gap-3 rounded-xl border border-stone-200/80 bg-white/70 p-4 transition duration-200 hover:-translate-y-0.5 hover:border-rose-200 hover:bg-white hover:shadow-[0_20px_50px_-30px_rgba(244,63,94,.4)] sm:flex-row sm:items-center">
       ...
       {plans.isError ? (
        ...
        <div className="grid gap-3 sm:grid-cols-2">
         {plans.data?.items.map((plan) => (
          <div key={plan.id} className="group rounded-xl border border-stone-200/80 bg-white/70 p-4 transition duration-200 hover:-translate-y-1 hover:border-rose-200 hover:shadow-[0_20px_50px_-30px_rgba(244,63,94,.4)]">
