...
export default function ForgotPasswordPage() {
 ...
 return (
  <Card className="overflow-hidden rounded-xl border-white/40 bg-white/85 py-0 shadow-[0_35px_90px_-40px_rgba(79,70,229,.55)] backdrop-blur-2xl">
   <CardHeader className="relative overflow-hidden bg-[linear-gradient(135deg,#172554_0%,#3730a3_45%,#a21caf_100%)] p-6 text-white">
    ...
    <div className="relative flex items-center gap-3">
     <span className="flex size-12 shrink-0 items-center justify-center rounded-lg bg-white/15 ring-1 ring-white/25 backdrop-blur">
      <KeyRound className="size-6" aria-hidden="true" />
     </span>
     <div>
      <p className="inline-flex items-center gap-1.5 rounded-full border border-white/20 bg-white/10 px-2.5 py-1 text-xs font-black uppercase tracking-[.18em]">
   ...
   <CardContent className="p-6">
    {submitted ? (
     <div className="rounded-xl border border-emerald-200 bg-gradient-to-br from-emerald-50/80 to-teal-50/50 p-5 text-center" role="status">
