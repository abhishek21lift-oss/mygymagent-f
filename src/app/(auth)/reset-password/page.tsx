...
function ResetPasswordForm() {
 ...
 <CardTitle className="mt-1.5 font-semibold text-2xl font-semibold tracking-tight text-white">Choose a new password</CardTitle>
 </div>
 </div>
 ...
 <FormControl>
 <Input type="password" autoComplete="new-password" {...field} className="min-h-11 rounded-lg focus-visible:ring-emerald-600" />
 </FormControl>
 <FormMessage />
 </FormItem>
 )}
