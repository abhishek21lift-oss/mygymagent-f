...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
 ...
 <div className="flex flex-col items-center gap-2 rounded-lg border border-border/60 bg-card/80 px-6 py-5 shadow-sm ">
 <Image
 ...
 <div className="rounded-lg border border-border/60 bg-card/85 p-1 shadow-sm ">
