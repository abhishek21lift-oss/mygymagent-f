...
export default function RegisterPage() {
 ...
 <FormControl>
 <Input placeholder="Iron Paradise Gym" {...field} className="min-h-11 rounded-lg focus-visible:ring-violet-600" />
 </FormControl>
 <FormMessage />
 </FormItem>
 )}
 ...
 <FormControl>
 <Input autoComplete="given-name" {...field} className="min-h-11 rounded-lg" />
 </FormControl>
 <FormMessage />
 </FormItem>
 )}
 ...
 <FormControl>
 <Input autoComplete="family-name" {...field} className="min-h-11 rounded-lg" />
 </FormControl>
 <FormMessage />
 </FormItem>
 )}
 ...
 <FormControl>
 <Input type="email" autoComplete="email" {...field} className="min-h-11 rounded-lg" />
 </FormControl>
 <FormMessage />
 </FormItem>
 )}
 ...
 <FormControl>
 <Input type="password" autoComplete="new-password" {...field} className="min-h-11 rounded-lg" />
 </FormControl>
 <FormMessage />
 </FormItem>
 )}
